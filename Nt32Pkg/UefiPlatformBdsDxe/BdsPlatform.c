...
/**
  ...
  @retval EFI_SUCCESS       Success connect at least one ConIn and ConOut  device,
                            there must have one ConOut device is  active vga
                            device.
  @retval EFI_STATUS        Return the status of  BdsLibConnectAllDefaultConsoles
                            ()
  ...
  )
{
  ...
  if (QuietBoot) {
    //
    // WQBugBug: R9 is using EnableQuietBootEx
    //
