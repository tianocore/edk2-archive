...
/**
  ...
  @param  Lenght                most possible length of AStr
...
/**
  ...
  @param  BootOrderList         On input, the original boot order list. On output,
                                the new boot order list attached with the created
                                node.
  @param  BootOrderListSize     On input, the original size of boot order list.
  @param       On               output, the size of new boot order list.
...
/**
  ...
  @retval EFI_SUCCESS           The boot options are added successfully or they are
                                already in boot options.
  @retval others                An error occurred when creating legacy boot
                                options.
