...
/**
  ...
  @return NULL                Cannot allocate memory for current menu
  @return entry
  @return Others              A valid pointer pointing to the allocated
  @return memory pool for current menu entry
...
/**
  ...
  @return TRUE         -- Get files from current dir successfully
  @return FALSE        -- Can't get files from current dir
...
/**
  ...
  @return The device info of legacy device.
...
/**
  ...
  @return Caller is responsible to free the returned string.
...
//
// WQBugBug: Buffer is not set as NULL. This is different with implementation in DxeMemoryAllocationLib instance.
//
#if 0
/**
