...
/**
  ...
  @param[in]  SwSmiInputValue          The SwSmiInputValue to indentify the SmmSwDispatch2 context
...
/**
  ...
  @param[in]  DispatchHandle          The DispatchHandle to indentify the SmmSwDispatch2Thunk context
  ...
  )
{
  ...
  //
  // Assign the R_APM_CNT and R_APM_STS to SWSMI Trigger port and Data Port
  //
  mSmiTriggerRegister = R_APM_CNT;
